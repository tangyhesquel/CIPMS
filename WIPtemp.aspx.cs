...
public partial class WIPtemp : System.Web.UI.Page
{
    ...
    public static String Goquery(string factory, string svTYPE, string joborderno, string go, string process, string bybundle, string bypart, string bycolorsize)
    {
        ...
        if (process == "all")
        {
            ...
            string cutqty = "", embqty = "", prtqty = "", matchingqty = "", dcqty = "";
            int ttlcutqty = 0, ttlembqty = 0, ttlprtqty = 0, ttlmatchingqty = 0, ttldcqty = 0;
            int j = 0;
            ...
            while (sqlDr.Read())
            {
                ...
                if (joborderno == "" && go == "")
                {
                    ...
                    table1 += "<td style='vertical-align:middle; text-align:center; width:18%;'>" + cutqty + "</td>";
                    table1 += "<td style='vertical-align:middle; text-align:center; width:18%;'>" + prtqty + "</td>";
                    table1 += "<td style='vertical-align:middle; text-align:center; width:18%;'>" + embqty + "</td>";
                    table1 += "<td style='vertical-align:middle; text-align:center; width:18%;'>" + matchingqty + "</td>";
                    table1 += "<td style='vertical-align:middle; text-align:center; width:18%;'>" + dcqty + "</td></tr>";
                    j++;
                }
                else
                {
                    if (bybundle == "false" && bypart == "false" && bycolorsize == "false")
                    {
                        if (j % 2 == 1)
                            ...
                            table1 += "<tr onmouseover=$(this).addClass('over') onmouseout=$(this).removeClass('over')>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + (j + 1) + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:20%;'>" + sqlDr["CUT_LINE"].ToString() + "</td>";
                    ...
                    else if (bybundle == "true" && bypart == "false" && bycolorsize == "false")
                    {
                        if (j % 2 == 1)
                            ...
                            table1 += "<tr onmouseover=$(this).addClass('over') onmouseout=$(this).removeClass('over')>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + (j + 1) + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + sqlDr["CUT_LINE"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:20%;'>" + sqlDr["JOB_ORDER_NO"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + sqlDr["BUNDLE_NO"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + cutqty + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + prtqty + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + embqty + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + matchingqty + "</td>";
                    ...
                    else if (bybundle == "false" && bypart == "true" && bycolorsize == "false")
                    {
                        ...
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + sqlDr["CUT_LINE"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:20%;'>" + sqlDr["JOB_ORDER_NO"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + sqlDr["PART_DESC"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + cutqty + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + prtqty + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + embqty + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:10%;'>" + matchingqty + "</td>";
                    ...
                    else if (bybundle == "false" && bypart == "false" && bycolorsize == "true")
                    {
                        ...
                        table1 += "<td style='vertical-align:middle; text-align:center; width:19%;'>" + sqlDr["JOB_ORDER_NO"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:9%;'>" + sqlDr["COLOR_CD"].ToString() + "</td>";
                        table1 += "<td style='vertical-align:middle; text-align:center; width:9%;'>" + sqlDr["SIZE_CD"].ToString() + "</td>";
